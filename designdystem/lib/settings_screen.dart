...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dead = controller.state.isDead;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          FilledButton.icon(
            onPressed: dead ? () => controller.revive(reviveType: 'epic') : null,
            icon: const Icon(Icons.flash_on),
            label: const Text('Revivir ÉPICO (full HP)'),
          ),
          const SizedBox(height: 10),
          FilledButton.tonalIcon(
            onPressed: dead ? () => controller.revive(reviveType: 'costly') : null,
          ...
          OutlinedButton.icon(
            onPressed: () async {
              ...
              if (ok) await controller.resetAll();
