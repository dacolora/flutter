...
import 'package:mylifegame/create_habit/area_onboarding_screen.dart';
import 'package:mylifegame/create_habit/glow_card.dart';
import 'package:mylifegame/domain/entities/life_area.dart';
import 'package:mylifegame/domain/entities/life_area_catalog.dart';
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        ...
        Text(
          'Elige un área y el tipo de persona te conviertes al dominarla.',
