      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Text(area.iconGlyph, style: const TextStyle(fontSize: 28,color: Colors.white)),
          ),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
             ...
             Text(slide.symbol, style: const TextStyle(fontSize: 36)),
            ...
            const Spacer(),
            Text(
              'Consejo: Solo se puede mejorar lo que se mide',
              style: TextStyle(
                fontSize: 12.0,
                height: 1.35,
